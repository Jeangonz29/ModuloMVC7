...
nameInput.addEventListener('input', e=>{ //aqui el input se puede poner con change tambien
    ...
    /*if(e.target.value === ''){
        ...
        nameInput.classList.add('focus:outline-blue-600'); //recordar el border para usar una equis o una check va de la mando con change
    }else{
